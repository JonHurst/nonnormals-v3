...
due to compressor outlet overheat or pack outlet overheat. The affected pack
should be turned off. A possible reason for this failure is loss of both
channels of an Air Conditioning System Controller (\ac{ACSC}). If this occurs,
the associated hot air trimming will also be lost (cockpit for \ac{ACSC} 1,
cabin for \ac{ACSC} 2).
...
turn off both packs and proceed as per Section \ref{sec-pack-fault}.
