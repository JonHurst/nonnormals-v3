...
\ac{ECAM} advises that the standby instrument indications may be unreliable…
...
disagreement, see Section \ref{sec-unreliable-airspeed}. If the speed does not
disagree, an \ac{AOA} sensor is providing incorrect data and there is a risk of
spurious stall warnings.
