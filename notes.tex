...
on. Initiate a descent; if above \ac{FL}160, this should be an Emergency Descent
(see Section \ref{sec-emer-descent}). Once the descent is established and all
relevant checklists are complete, check the position of the outflow valve and,
